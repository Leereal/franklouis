  ...
  return (
    <div className="pointer-events-none fixed inset-0 z-0 overflow-hidden" aria-hidden="true">
      <svg
        ...
        fill="none"
      >
        <g className="drift-a" stroke="#B9CBA4" strokeOpacity="0.14" strokeWidth="1.2">
        ...
        <g className="drift-b" stroke="#B9CBA4" strokeOpacity="0.13" strokeWidth="1.2">
        ...
        <g className="drift-a star-field" fill="#F4DFA6">
          {[
            ...
            [1300, 300, 1.6], [1480, 460, 2], [1360, 780, 1.7], [760, 800, 1.5],
            [60, 820, 1.8], [1560, 120, 1.5],
          ].map(([x, y, r], i) => (
            <circle key={i} cx={x} cy={y} r={r} opacity="0.35" />
          ))}
        </g>
        <circle cx="1240" cy="180" r="2.4" fill="#F6E9C5" className="node-pulse" />
        <circle cx="380" cy="700" r="2.4" fill="#F6E9C5" className="node-pulse" style={{ animationDelay: "1.2s" }} />
